...
use ADN\PluginUpdateChecker\v5p0\InstalledPackage;
use ADN\PluginUpdateChecker\v5p0\UpdateChecker as BaseUpdateChecker;
use ADN\PluginUpdateChecker\v5p0\Scheduler;
use ADN\PluginUpdateChecker\v5p0\DebugBar;

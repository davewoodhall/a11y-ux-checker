...
use ADN\PluginUpdateChecker\v5p0\Plugin;
use ADN\PluginUpdateChecker\v5p0\Theme;
use ADN\PluginUpdateChecker\v5p0\Vcs;
...
if ( !class_exists(PucFactory::class, false) ):
	...
	class PucFactory {
		 ...
		 * the appropriate implementation for your update source (JSON file, GitHub, etc).
		 *
